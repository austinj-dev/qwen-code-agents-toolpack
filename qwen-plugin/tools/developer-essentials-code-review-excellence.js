/**
 * Qwen Tool: code-review-excellence
 * Plugin: developer-essentials
 * Description: Master effective code review practices to provide constructive feedback, catch bugs early, and foster knowledge sharing while maintaining team morale. Use when reviewing pull requests, establishing review standards, or mentoring developers.
 */

/**
 * Execute the code-review-excellence skill
 * @param {Object} params - Parameters for the skill
 * @returns {Object} Result of the skill execution
 */
async function executeCodeReviewExcellenceSkill(params = {}) {
    // Implementation of the code-review-excellence skill
    // This is a converted Claude skill for Qwen CLI
    console.log('Executing code-review-excellence skill from developer-essentials plugin');
...
- **scripts/pr-analyzer.py**: Analyze PR complexity and suggest reviewers`
    ...
    return {
        status: 'success',
        skill: skillInfo,
        message: 'Executed code-review-excellence skill'
    };
}
...
module.exports = {
    ...
    handler: executeCodeReviewExcellenceSkill
};
