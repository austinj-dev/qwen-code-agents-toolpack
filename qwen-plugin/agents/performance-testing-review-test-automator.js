...
/**
 * Execute the test-automator agent
 ...
 */
async function executeTestAutomatorAgent(context = {}, input = '') {
    // Implementation of the test-automator agent
    // This is a converted Claude agent for Qwen CLI

    console.log('Executing test-automator agent from performance-testing-review plugin');
    ...
    const agentInfo = {
        ...
        model: 'sonnet',
        description: `Master AI-powered test automation with modern frameworks, self-healing tests, and comprehensive quality engineering. Build scalable testing strategies with advanced CI/CD integration. Use PROACTIVELY for testing automation or quality assurance.`,
        behavior: `You are an expert test automation engineer specializing in AI-powered testing, modern frameworks, and comprehensive quality engineering strategies.
...
- "Set up continuous TDD verification in CI/CD pipeline"`,
    ...
    return {
        status: 'success',
        agent: agentInfo,
        message: 'Executed test-automator agent',
...
module.exports = {
    ...
    model: 'sonnet',
    plugin: 'performance-testing-review',
    execute: executeTestAutomatorAgent
};
