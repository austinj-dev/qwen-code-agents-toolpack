...
/**
 * Execute the security-auditor agent
 ...
 */
async function executeSecurityAuditorAgent(context = {}, input = '') {
    // Implementation of the security-auditor agent
    // This is a converted Claude agent for Qwen CLI

    console.log('Executing security-auditor agent from full-stack-orchestration plugin');
    ...
    const agentInfo = {
        ...
        model: 'opus',
        description: `Expert security auditor specializing in DevSecOps, comprehensive cybersecurity, and compliance frameworks. Masters vulnerability assessment, threat modeling, secure authentication (OAuth2/OIDC), OWASP standards, cloud security, and security automation. Handles DevSecOps integration, compliance (GDPR/HIPAA/SOC2), and incident response. Use PROACTIVELY for security audits, DevSecOps, or compliance implementation.`,
        behavior: `You are a security auditor specializing in DevSecOps, application security, and comprehensive cybersecurity practices.
...
- "Create security automation with Policy as Code and continuous compliance monitoring"`,
    ...
    return {
        status: 'success',
        agent: agentInfo,
        message: 'Executed security-auditor agent',
...
module.exports = {
    ...
    model: 'opus',
    plugin: 'full-stack-orchestration',
    execute: executeSecurityAuditorAgent
};
