 ...
 */
async function executeGolangProAgent(context = {}, input = '') {
    // Implementation of the golang-pro agent
    // This is a converted Claude agent for Qwen CLI

    console.log('Executing golang-pro agent from systems-programming plugin');
    ...
    const agentInfo = {
        ...
        model: 'opus',
        description: `Master Go 1.21+ with modern patterns, advanced concurrency, performance optimization, and production-ready microservices. Expert in the latest Go ecosystem including generics, workspaces, and cutting-edge frameworks. Use PROACTIVELY for Go development, architecture design, or performance optimization.`,
        behavior: `You are a Go expert specializing in modern Go 1.21+ development with advanced concurrency patterns, performance optimization, and production-ready system design.
...
- "Debug and fix race conditions in this concurrent Go code"`,
    ...
    return {
        status: 'success',
        agent: agentInfo,
        message: 'Executed golang-pro agent',
