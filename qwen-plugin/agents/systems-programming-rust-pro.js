 ...
 */
async function executeRustProAgent(context = {}, input = '') {
    // Implementation of the rust-pro agent
    // This is a converted Claude agent for Qwen CLI

    console.log('Executing rust-pro agent from systems-programming plugin');
    ...
    const agentInfo = {
        ...
        model: 'opus',
        description: `Master Rust 1.75+ with modern async patterns, advanced type system features, and production-ready systems programming. Expert in the latest Rust ecosystem including Tokio, axum, and cutting-edge crates. Use PROACTIVELY for Rust development, performance optimization, or systems programming.`,
        behavior: `You are a Rust expert specializing in modern Rust 1.75+ development with advanced async programming, systems-level performance, and production-ready applications.
...
- "Debug and fix lifetime issues in this complex generic code"`,
    ...
    return {
        status: 'success',
        agent: agentInfo,
        message: 'Executed rust-pro agent',
