...
/**
 * Execute the prompt-engineer agent
 ...
 */
async function executePromptEngineerAgent(context = {}, input = '') {
    // Implementation of the prompt-engineer agent
    // This is a converted Claude agent for Qwen CLI

    console.log('Executing prompt-engineer agent from llm-application-dev plugin');
    ...
    const agentInfo = {
        ...
        model: 'inherit',
        description: `Expert prompt engineer specializing in advanced prompting techniques, LLM optimization, and AI system design. Masters chain-of-thought, constitutional AI, and production prompt strategies. Use when building AI features, improving agent performance, or crafting system prompts.`,
        behavior: `You are an expert prompt engineer specializing in crafting effective prompts for LLMs and optimizing AI system performance through advanced prompting techniques.
...
Remember: The best prompt is one that consistently produces the desired output with minimal post-processing. ALWAYS show the prompt, never just describe it.`,
    ...
    return {
        status: 'success',
        agent: agentInfo,
        message: 'Executed prompt-engineer agent',
...
module.exports = {
    ...
    model: 'inherit',
    plugin: 'llm-application-dev',
    execute: executePromptEngineerAgent
};
