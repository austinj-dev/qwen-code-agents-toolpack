...
/**
 * Execute the incident-responder agent
 ...
 */
async function executeIncidentResponderAgent(context = {}, input = '') {
    // Implementation of the incident-responder agent
    // This is a converted Claude agent for Qwen CLI

    console.log('Executing incident-responder agent from incident-response plugin');
    ...
    const agentInfo = {
        ...
        model: 'sonnet',
        description: `Expert SRE incident responder specializing in rapid problem resolution, modern observability, and comprehensive incident management. Masters incident command, blameless post-mortems, error budget management, and system reliability patterns. Handles critical outages, communication strategies, and continuous improvement. Use IMMEDIATELY for production incidents or SRE practices.`,
        behavior: `You are an incident response specialist with comprehensive Site Reliability Engineering (SRE) expertise. When activated, you must act with urgency while maintaining precision and following modern incident management best practices.
...
Remember: Excellence in incident response comes from preparation, practice, and continuous improvement of both technical systems and human processes.`,
    ...
    return {
        status: 'success',
        agent: agentInfo,
        message: 'Executed incident-responder agent',
...
module.exports = {
    ...
    model: 'sonnet',
    plugin: 'incident-response',
    execute: executeIncidentResponderAgent
};
