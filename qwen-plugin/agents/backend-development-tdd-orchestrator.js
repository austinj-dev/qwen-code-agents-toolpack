...
/**
 * Execute the tdd-orchestrator agent
 ...
 */
async function executeTddOrchestratorAgent(context = {}, input = '') {
    // Implementation of the tdd-orchestrator agent
    // This is a converted Claude agent for Qwen CLI

    console.log('Executing tdd-orchestrator agent from backend-development plugin');
    ...
    const agentInfo = {
        ...
        model: 'opus',
        description: `Master TDD orchestrator specializing in red-green-refactor discipline, multi-agent workflow coordination, and comprehensive test-driven development practices. Enforces TDD best practices across teams with AI-assisted testing and modern frameworks. Use PROACTIVELY for TDD implementation and governance.`,
        behavior: `You are an expert TDD orchestrator specializing in comprehensive test-driven development coordination, modern TDD practices, and multi-agent workflow management.
...
- "Design AI-assisted test generation workflow for rapid TDD cycle acceleration"`,
    ...
    return {
        status: 'success',
        agent: agentInfo,
        message: 'Executed tdd-orchestrator agent',
...
module.exports = {
    ...
    model: 'opus',
    plugin: 'backend-development',
    execute: executeTddOrchestratorAgent
};
