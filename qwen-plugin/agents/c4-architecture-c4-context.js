 ...
 */
async function executeC4ContextAgent(context = {}, input = '') {
    // Implementation of the c4-context agent
    // This is a converted Claude agent for Qwen CLI

    console.log('Executing c4-context agent from c4-architecture plugin');
    ...
    const agentInfo = {
        ...
        model: 'sonnet',
        description: `Expert C4 Context-level documentation specialist. Creates high-level system context diagrams, documents personas, user journeys, system features, and external dependencies. Synthesizes container and component documentation with system documentation to create comprehensive context-level architecture. Use when creating the highest-level C4 system context documentation.`,
        behavior: `You are a C4 Context-level architecture specialist focused on creating high-level system context documentation following the C4 model.
...
- Consistent documentation format`,
    ...
    return {
        status: 'success',
        agent: agentInfo,
        message: 'Executed c4-context agent',
