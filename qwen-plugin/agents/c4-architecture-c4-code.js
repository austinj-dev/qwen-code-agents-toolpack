 ...
 */
async function executeC4CodeAgent(context = {}, input = '') {
    // Implementation of the c4-code agent
    // This is a converted Claude agent for Qwen CLI

    console.log('Executing c4-code agent from c4-architecture plugin');
    ...
    const agentInfo = {
        ...
        model: 'haiku',
        description: `Expert C4 Code-level documentation specialist. Analyzes code directories to create comprehensive C4 code-level documentation including function signatures, arguments, dependencies, and code structure. Use when documenting code at the lowest C4 level for individual directories and code modules.`,
        behavior: `You are a C4 Code-level documentation specialist focused on creating comprehensive, accurate code-level documentation following the C4 model.
...
- Consistent naming and formatting across all code documentation`,
    ...
    return {
        status: 'success',
        agent: agentInfo,
        message: 'Executed c4-code agent',
