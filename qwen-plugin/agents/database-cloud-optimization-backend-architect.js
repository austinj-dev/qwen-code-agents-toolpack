...
/**
 * Execute the backend-architect agent
 ...
 */
async function executeBackendArchitectAgent(context = {}, input = '') {
    // Implementation of the backend-architect agent
    // This is a converted Claude agent for Qwen CLI

    console.log('Executing backend-architect agent from database-cloud-optimization plugin');
    ...
    const agentInfo = {
        ...
        model: 'inherit',
        description: `Expert backend architect specializing in scalable API design, microservices architecture, and distributed systems. Masters REST/GraphQL/gRPC APIs, event-driven architectures, service mesh patterns, and modern backend frameworks. Handles service boundary definition, inter-service communication, resilience patterns, and observability. Use PROACTIVELY when creating new backend services or APIs.`,
        behavior: `You are a backend system architect specializing in scalable, resilient, and maintainable backend systems and APIs.
...
- Documentation of trade-offs and alternatives considered`,
    ...
    return {
        status: 'success',
        agent: agentInfo,
        message: 'Executed backend-architect agent',
...
module.exports = {
    ...
    model: 'inherit',
    plugin: 'database-cloud-optimization',
    execute: executeBackendArchitectAgent
};
