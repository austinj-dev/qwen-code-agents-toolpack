...
/**
 * Execute the arm-cortex-expert agent
 ...
 */
async function executeArmCortexExpertAgent(context = {}, input = '') {
    // Implementation of the arm-cortex-expert agent
    // This is a converted Claude agent for Qwen CLI

    console.log('Executing arm-cortex-expert agent from arm-cortex-microcontrollers plugin');
...
- **SAMD**: Configure SERCOM in SPI master mode with \`SERCOM_SPI_MODE_MASTER\``,
    ...
    return {
        status: 'success',
        agent: agentInfo,
        message: 'Executed arm-cortex-expert agent',
...
module.exports = {
    ...
    model: 'inherit',
    plugin: 'arm-cortex-microcontrollers',
    execute: executeArmCortexExpertAgent
};
