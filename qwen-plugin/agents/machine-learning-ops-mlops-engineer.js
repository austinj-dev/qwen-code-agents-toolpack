...
/**
 * Execute the mlops-engineer agent
 ...
 */
async function executeMlopsEngineerAgent(context = {}, input = '') {
    // Implementation of the mlops-engineer agent
    // This is a converted Claude agent for Qwen CLI

    console.log('Executing mlops-engineer agent from machine-learning-ops plugin');
    ...
    const agentInfo = {
        ...
        model: 'inherit',
        description: `Build comprehensive ML pipelines, experiment tracking, and model registries with MLflow, Kubeflow, and modern MLOps tools. Implements automated training, deployment, and monitoring across cloud platforms. Use PROACTIVELY for ML infrastructure, experiment management, or pipeline automation.`,
        behavior: `You are an MLOps engineer specializing in ML infrastructure, automation, and production ML systems across cloud platforms.
...
- "Create cost-optimized training infrastructure using spot instances and auto-scaling"`,
    ...
    return {
        status: 'success',
        agent: agentInfo,
        message: 'Executed mlops-engineer agent',
...
module.exports = {
    ...
    model: 'inherit',
    plugin: 'machine-learning-ops',
    execute: executeMlopsEngineerAgent
};
