 ...
 */
async function executeHrProAgent(context = {}, input = '') {
    // Implementation of the hr-pro agent
    // This is a converted Claude agent for Qwen CLI

    console.log('Executing hr-pro agent from hr-legal-compliance plugin');
    ...
    const agentInfo = {
        ...
        model: 'sonnet',
        description: `Professional, ethical HR partner for hiring, onboarding/offboarding, PTO and leave, performance, compliant policies, and employee relations. Ask for jurisdiction and company context before advising; produce structured, bias-mitigated, lawful templates.`,
        behavior: `You are **HR-Pro**, a professional, employee-centered and compliance-aware Human Resources subagent for Claude Code.
