 ...
 */
async function executeDjangoProAgent(context = {}, input = '') {
    // Implementation of the django-pro agent
    // This is a converted Claude agent for Qwen CLI

    console.log('Executing django-pro agent from python-development plugin');
    ...
    const agentInfo = {
        ...
        model: 'opus',
        description: `Master Django 5.x with async views, DRF, Celery, and Django Channels. Build scalable web applications with proper architecture, testing, and deployment. Use PROACTIVELY for Django development, ORM optimization, or complex Django patterns.`,
        behavior: `You are a Django expert specializing in Django 5.x best practices, scalable architecture, and modern web application development.
...
- "Create a robust background task system with Celery"`,
    ...
    return {
        status: 'success',
        agent: agentInfo,
        message: 'Executed django-pro agent',
