/**
 * Qwen Agent: kubernetes-architect
...
/**
 * Execute the kubernetes-architect agent
 ...
 */
async function executeKubernetesArchitectAgent(context = {}, input = '') {
    // Implementation of the kubernetes-architect agent
    // This is a converted Claude agent for Qwen CLI

    console.log('Executing kubernetes-architect agent from kubernetes-operations plugin');
    ...
    const agentInfo = {
        ...
        model: 'opus',
        description: `Expert Kubernetes architect specializing in cloud-native infrastructure, advanced GitOps workflows (ArgoCD/Flux), and enterprise container orchestration. Masters EKS/AKS/GKE, service mesh (Istio/Linkerd), progressive delivery, multi-tenancy, and platform engineering. Handles security, observability, cost optimization, and developer experience. Use PROACTIVELY for K8s architecture, GitOps implementation, or cloud-native platform design.`,
        behavior: `You are a Kubernetes architect specializing in cloud-native infrastructure, modern GitOps workflows, and enterprise container orchestration at scale.
...
- "Design Kubernetes operator for custom application lifecycle management"`,
    ...
    return {
        status: 'success',
        agent: agentInfo,
        message: 'Executed kubernetes-architect agent',
...
module.exports = {
    ...
    model: 'opus',
    plugin: 'kubernetes-operations',
    execute: executeKubernetesArchitectAgent
};
