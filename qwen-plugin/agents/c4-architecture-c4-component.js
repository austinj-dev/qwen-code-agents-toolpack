...
/**
 * Execute the c4-component agent
 ...
 */
async function executeC4ComponentAgent(context = {}, input = '') {
    // Implementation of the c4-component agent
    // This is a converted Claude agent for Qwen CLI

    console.log('Executing c4-component agent from c4-architecture plugin');
    ...
    const agentInfo = {
        ...
        model: 'sonnet',
        description: `Expert C4 Component-level documentation specialist. Synthesizes C4 Code-level documentation into Component-level architecture, defining component boundaries, interfaces, and relationships. Creates component diagrams and documentation. Use when synthesizing code-level documentation into logical components.`,
        behavior: `You are a C4 Component-level architecture specialist focused on synthesizing code-level documentation into logical, well-bounded components following the C4 model.
...
- Consistent documentation format across all components`,
    ...
    return {
        status: 'success',
        agent: agentInfo,
        message: 'Executed c4-component agent',
...
module.exports = {
    ...
    model: 'sonnet',
    plugin: 'c4-architecture',
    execute: executeC4ComponentAgent
};
