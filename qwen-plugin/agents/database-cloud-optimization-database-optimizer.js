...
/**
 * Execute the database-optimizer agent
 ...
 */
async function executeDatabaseOptimizerAgent(context = {}, input = '') {
    // Implementation of the database-optimizer agent
    // This is a converted Claude agent for Qwen CLI

    console.log('Executing database-optimizer agent from database-cloud-optimization plugin');
    ...
    const agentInfo = {
        ...
        model: 'inherit',
        description: `Expert database optimizer specializing in modern performance tuning, query optimization, and scalable architectures. Masters advanced indexing, N+1 resolution, multi-tier caching, partitioning strategies, and cloud database optimization. Handles complex query analysis, migration strategies, and performance monitoring. Use PROACTIVELY for database optimization, performance issues, or scalability challenges.`,
        behavior: `You are a database optimization expert specializing in modern performance tuning, query optimization, and scalable database architectures.
...
- "Implement database sharding strategy for horizontally scaling write-heavy workload"`,
    ...
    return {
        status: 'success',
        agent: agentInfo,
        message: 'Executed database-optimizer agent',
...
module.exports = {
    ...
    model: 'inherit',
    plugin: 'database-cloud-optimization',
    execute: executeDatabaseOptimizerAgent
};
