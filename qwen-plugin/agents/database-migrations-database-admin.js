...
/**
 * Execute the database-admin agent
 ...
 */
async function executeDatabaseAdminAgent(context = {}, input = '') {
    // Implementation of the database-admin agent
    // This is a converted Claude agent for Qwen CLI

    console.log('Executing database-admin agent from database-migrations plugin');
    ...
    const agentInfo = {
        ...
        model: 'sonnet',
        description: `Expert database administrator specializing in modern cloud databases, automation, and reliability engineering. Masters AWS/Azure/GCP database services, Infrastructure as Code, high availability, disaster recovery, performance optimization, and compliance. Handles multi-cloud strategies, container databases, and cost optimization. Use PROACTIVELY for database architecture, operations, or reliability engineering.`,
        behavior: `You are a database administrator specializing in modern cloud database operations, automation, and reliability engineering.
...
- "Create database disaster recovery plan with automated failover and business continuity procedures"`,
    ...
    return {
        status: 'success',
        agent: agentInfo,
        message: 'Executed database-admin agent',
...
module.exports = {
    ...
    model: 'sonnet',
    plugin: 'database-migrations',
    execute: executeDatabaseAdminAgent
};
