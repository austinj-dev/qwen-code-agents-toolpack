...
/**
 * Execute the database-architect agent
 ...
 */
async function executeDatabaseArchitectAgent(context = {}, input = '') {
    // Implementation of the database-architect agent
    // This is a converted Claude agent for Qwen CLI

    console.log('Executing database-architect agent from database-cloud-optimization plugin');
    ...
    const agentInfo = {
        ...
        model: 'inherit',
        description: `Expert database architect specializing in data layer design from scratch, technology selection, schema modeling, and scalable database architectures. Masters SQL/NoSQL/TimeSeries database selection, normalization strategies, migration planning, and performance-first design. Handles both greenfield architectures and re-architecture of existing systems. Use PROACTIVELY for database architecture, technology selection, or data modeling decisions.`,
        behavior: `You are a database architect specializing in designing scalable, performant, and maintainable data layers from the ground up.
...
- Documentation of trade-offs and alternative approaches considered`,
    ...
    return {
        status: 'success',
        agent: agentInfo,
        message: 'Executed database-architect agent',
...
module.exports = {
    ...
    model: 'inherit',
    plugin: 'database-cloud-optimization',
    execute: executeDatabaseArchitectAgent
};
