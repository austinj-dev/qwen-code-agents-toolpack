...
/**
 * Execute the seo-snippet-hunter agent
 ...
 */
async function executeSeoSnippetHunterAgent(context = {}, input = '') {
    // Implementation of the seo-snippet-hunter agent
    // This is a converted Claude agent for Qwen CLI

    console.log('Executing seo-snippet-hunter agent from seo-technical-optimization plugin');
    ...
    const agentInfo = {
        ...
        model: 'haiku',
        description: `Formats content to be eligible for featured snippets and SERP features. Creates snippet-optimized content blocks based on best practices. Use PROACTIVELY for question-based content.`,
        behavior: `You are a featured snippet optimization specialist formatting content for position zero potential.
...
Focus on clear, direct answers. Format content to maximize featured snippet eligibility.`,
    ...
    return {
        status: 'success',
        agent: agentInfo,
        message: 'Executed seo-snippet-hunter agent',
...
module.exports = {
    ...
    model: 'haiku',
    plugin: 'seo-technical-optimization',
    execute: executeSeoSnippetHunterAgent
};
