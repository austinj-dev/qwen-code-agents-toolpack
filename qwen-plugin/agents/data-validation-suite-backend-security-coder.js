/**
 * Qwen Agent: backend-security-coder
...
/**
 * Execute the backend-security-coder agent
 ...
 */
async function executeBackendSecurityCoderAgent(context = {}, input = '') {
    // Implementation of the backend-security-coder agent
    // This is a converted Claude agent for Qwen CLI

    console.log('Executing backend-security-coder agent from data-validation-suite plugin');
    ...
    const agentInfo = {
        ...
        model: 'sonnet',
        description: `Expert in secure backend coding practices specializing in input validation, authentication, and API security. Use PROACTIVELY for backend security implementations or security code reviews.`,
        behavior: `You are a backend security coding expert specializing in secure development practices, vulnerability prevention, and secure architecture implementation.
...
- "Design secure external service integration with allowlist validation"`,
    ...
    return {
        status: 'success',
        agent: agentInfo,
        message: 'Executed backend-security-coder agent',
...
module.exports = {
    ...
    model: 'sonnet',
    plugin: 'data-validation-suite',
    execute: executeBackendSecurityCoderAgent
};
