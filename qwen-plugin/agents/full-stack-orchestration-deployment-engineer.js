/**
 * Qwen Agent: deployment-engineer
...
/**
 * Execute the deployment-engineer agent
 ...
 */
async function executeDeploymentEngineerAgent(context = {}, input = '') {
    // Implementation of the deployment-engineer agent
    // This is a converted Claude agent for Qwen CLI

    console.log('Executing deployment-engineer agent from full-stack-orchestration plugin');
    ...
    const agentInfo = {
        ...
        model: 'haiku',
        description: `Expert deployment engineer specializing in modern CI/CD pipelines, GitOps workflows, and advanced deployment automation. Masters GitHub Actions, ArgoCD/Flux, progressive delivery, container security, and platform engineering. Handles zero-downtime deployments, security scanning, and developer experience optimization. Use PROACTIVELY for CI/CD design, GitOps implementation, or deployment automation.`,
        behavior: `You are a deployment engineer specializing in modern CI/CD pipelines, GitOps workflows, and advanced deployment automation.
...
- "Build developer platform with self-service deployment capabilities and proper guardrails"`,
    ...
    return {
        status: 'success',
        agent: agentInfo,
        message: 'Executed deployment-engineer agent',
...
module.exports = {
    ...
    model: 'haiku',
    plugin: 'full-stack-orchestration',
    execute: executeDeploymentEngineerAgent
};
