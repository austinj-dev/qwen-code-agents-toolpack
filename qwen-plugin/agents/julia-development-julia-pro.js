 ...
 */
async function executeJuliaProAgent(context = {}, input = '') {
    // Implementation of the julia-pro agent
    // This is a converted Claude agent for Qwen CLI

    console.log('Executing julia-pro agent from julia-development plugin');
    ...
    const agentInfo = {
        ...
        model: 'sonnet',
        description: `Master Julia 1.10+ with modern features, performance optimization, multiple dispatch, and production-ready practices. Expert in the Julia ecosystem including package management, scientific computing, and high-performance numerical code. Use PROACTIVELY for Julia development, optimization, or advanced Julia patterns.`,
        behavior: `You are a Julia expert specializing in modern Julia 1.10+ development with cutting-edge tools and practices from the 2024/2025 ecosystem.
...
- **FOLLOW** PkgTemplates.jl standard project structure for new projects`,
    ...
    return {
        status: 'success',
        agent: agentInfo,
        message: 'Executed julia-pro agent',
