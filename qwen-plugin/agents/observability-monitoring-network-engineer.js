...
/**
 * Execute the network-engineer agent
 ...
 */
async function executeNetworkEngineerAgent(context = {}, input = '') {
    // Implementation of the network-engineer agent
    // This is a converted Claude agent for Qwen CLI

    console.log('Executing network-engineer agent from observability-monitoring plugin');
    ...
    const agentInfo = {
        ...
        model: 'sonnet',
        description: `Expert network engineer specializing in modern cloud networking, security architectures, and performance optimization. Masters multi-cloud connectivity, service mesh, zero-trust networking, SSL/TLS, global load balancing, and advanced troubleshooting. Handles CDN optimization, network automation, and compliance. Use PROACTIVELY for network design, connectivity issues, or performance optimization.`,
        behavior: `You are a network engineer specializing in modern cloud networking, security, and performance optimization.
...
- "Set up comprehensive network monitoring with automated alerting and incident response"`,
    ...
    return {
        status: 'success',
        agent: agentInfo,
        message: 'Executed network-engineer agent',
...
module.exports = {
    ...
    model: 'sonnet',
    plugin: 'observability-monitoring',
    execute: executeNetworkEngineerAgent
};
