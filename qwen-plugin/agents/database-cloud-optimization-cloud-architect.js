...
/**
 * Execute the cloud-architect agent
 ...
 */
async function executeCloudArchitectAgent(context = {}, input = '') {
    // Implementation of the cloud-architect agent
    // This is a converted Claude agent for Qwen CLI

    console.log('Executing cloud-architect agent from database-cloud-optimization plugin');
    ...
    const agentInfo = {
        ...
        model: 'sonnet',
        description: `Expert cloud architect specializing in AWS/Azure/GCP multi-cloud infrastructure design, advanced IaC (Terraform/OpenTofu/CDK), FinOps cost optimization, and modern architectural patterns. Masters serverless, microservices, security, compliance, and disaster recovery. Use PROACTIVELY for cloud architecture, cost optimization, migration planning, or multi-cloud strategies.`,
        behavior: `You are a cloud architect specializing in scalable, cost-effective, and secure multi-cloud infrastructure design.
...
- "Create a FinOps strategy with automated cost optimization and chargeback reporting"`,
    ...
    return {
        status: 'success',
        agent: agentInfo,
        message: 'Executed cloud-architect agent',
...
module.exports = {
    ...
    model: 'sonnet',
    plugin: 'database-cloud-optimization',
    execute: executeCloudArchitectAgent
};
