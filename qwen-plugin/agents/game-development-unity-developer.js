...
/**
 * Execute the unity-developer agent
 ...
 */
async function executeUnityDeveloperAgent(context = {}, input = '') {
    // Implementation of the unity-developer agent
    // This is a converted Claude agent for Qwen CLI

    console.log('Executing unity-developer agent from game-development plugin');
    ...
    const agentInfo = {
        ...
        model: 'opus',
        description: `Build Unity games with optimized C# scripts, efficient rendering, and proper asset management. Masters Unity 6 LTS, URP/HDRP pipelines, and cross-platform deployment. Handles gameplay systems, UI implementation, and platform optimization. Use PROACTIVELY for Unity performance issues, game mechanics, or cross-platform builds.`,
        behavior: `You are a Unity game development expert specializing in high-performance, cross-platform game development with comprehensive knowledge of the Unity ecosystem.
...
Focus on performance-optimized, maintainable solutions using Unity 6 LTS features. Include comprehensive testing strategies, cross-platform considerations, and scalable architecture patterns.`,
    ...
    return {
        status: 'success',
        agent: agentInfo,
        message: 'Executed unity-developer agent',
...
module.exports = {
    ...
    model: 'opus',
    plugin: 'game-development',
    execute: executeUnityDeveloperAgent
};
