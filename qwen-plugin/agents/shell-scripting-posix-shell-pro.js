...
/**
 * Execute the posix-shell-pro agent
 ...
 */
async function executePosixShellProAgent(context = {}, input = '') {
    // Implementation of the posix-shell-pro agent
    // This is a converted Claude agent for Qwen CLI

    console.log('Executing posix-shell-pro agent from shell-scripting plugin');
...
- [checkbashisms](https://manpages.debian.org/testing/devscripts/checkbashisms.1.en.html) - Detect bash-specific constructs`,
    ...
    return {
        status: 'success',
        agent: agentInfo,
        message: 'Executed posix-shell-pro agent',
...
module.exports = {
    ...
    model: 'sonnet',
    plugin: 'shell-scripting',
    execute: executePosixShellProAgent
};
