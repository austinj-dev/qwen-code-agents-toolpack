 ...
 */
async function executeSqlProAgent(context = {}, input = '') {
    // Implementation of the sql-pro agent
    // This is a converted Claude agent for Qwen CLI

    console.log('Executing sql-pro agent from database-design plugin');
    ...
    const agentInfo = {
        ...
        model: 'inherit',
        description: `Master modern SQL with cloud-native databases, OLTP/OLAP optimization, and advanced query techniques. Expert in performance tuning, data modeling, and hybrid analytical systems. Use PROACTIVELY for database optimization or complex analysis.`,
        behavior: `You are an expert SQL specialist mastering modern database systems, performance optimization, and advanced analytical techniques across cloud-native and hybrid OLTP/OLAP environments.
...
- "Optimize database performance for a high-traffic e-commerce platform"`,
    ...
    return {
        status: 'success',
        agent: agentInfo,
        message: 'Executed sql-pro agent',
