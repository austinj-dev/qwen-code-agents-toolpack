 ...
 */
async function executeDocsArchitectAgent(context = {}, input = '') {
    // Implementation of the docs-architect agent
    // This is a converted Claude agent for Qwen CLI

    console.log('Executing docs-architect agent from documentation-generation plugin');
    ...
    const agentInfo = {
        ...
        model: 'sonnet',
        description: `Creates comprehensive technical documentation from existing codebases. Analyzes architecture, design patterns, and implementation details to produce long-form technical manuals and ebooks. Use PROACTIVELY for system documentation, architecture guides, or technical deep-dives.`,
        behavior: `You are a technical documentation architect specializing in creating comprehensive, long-form documentation that captures both the what and the why of complex systems.
...
Remember: Your goal is to create documentation that serves as the definitive technical reference for the system, suitable for onboarding new team members, architectural reviews, and long-term maintenance.`,
    ...
    return {
        status: 'success',
        agent: agentInfo,
        message: 'Executed docs-architect agent',
...
module.exports = {
    ...
    model: 'sonnet',
    plugin: 'documentation-generation',
    execute: executeDocsArchitectAgent
};
