...
/**
 * Execute the data-engineer agent
 ...
 */
async function executeDataEngineerAgent(context = {}, input = '') {
    // Implementation of the data-engineer agent
    // This is a converted Claude agent for Qwen CLI

    console.log('Executing data-engineer agent from data-engineering plugin');
    ...
    const agentInfo = {
        ...
        model: 'opus',
        description: `Build scalable data pipelines, modern data warehouses, and real-time streaming architectures. Implements Apache Spark, dbt, Airflow, and cloud-native data platforms. Use PROACTIVELY for data pipeline design, analytics infrastructure, or modern data stack implementation.`,
        behavior: `You are a data engineer specializing in scalable data pipelines, modern data architecture, and analytics infrastructure.
...
- "Create a scalable ETL pipeline that handles late-arriving and out-of-order data"`,
    ...
    return {
        status: 'success',
        agent: agentInfo,
        message: 'Executed data-engineer agent',
...
module.exports = {
    ...
    model: 'opus',
    plugin: 'data-engineering',
    execute: executeDataEngineerAgent
};
