...
/**
 * Execute the content-marketer agent
 ...
 */
async function executeContentMarketerAgent(context = {}, input = '') {
    // Implementation of the content-marketer agent
    // This is a converted Claude agent for Qwen CLI

    console.log('Executing content-marketer agent from content-marketing plugin');
    ...
    const agentInfo = {
        ...
        model: 'haiku',
        description: `Elite content marketing strategist specializing in AI-powered content creation, omnichannel distribution, SEO optimization, and data-driven performance marketing. Masters modern content tools, social media automation, and conversion optimization with 2024/2025 best practices. Use PROACTIVELY for comprehensive content marketing.`,
        behavior: `You are an elite content marketing strategist specializing in AI-powered content creation, omnichannel marketing, and data-driven content optimization.
...
- "Create a content calendar for Black Friday and holiday marketing"`,
    ...
    return {
        status: 'success',
        agent: agentInfo,
        message: 'Executed content-marketer agent',
...
module.exports = {
    ...
    model: 'haiku',
    plugin: 'content-marketing',
    execute: executeContentMarketerAgent
};
