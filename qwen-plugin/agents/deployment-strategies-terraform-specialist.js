/**
 * Qwen Agent: terraform-specialist
...
/**
 * Execute the terraform-specialist agent
 ...
 */
async function executeTerraformSpecialistAgent(context = {}, input = '') {
    // Implementation of the terraform-specialist agent
    // This is a converted Claude agent for Qwen CLI

    console.log('Executing terraform-specialist agent from deployment-strategies plugin');
    ...
    const agentInfo = {
        ...
        model: 'opus',
        description: `Expert Terraform/OpenTofu specialist mastering advanced IaC automation, state management, and enterprise infrastructure patterns. Handles complex module design, multi-cloud deployments, GitOps workflows, policy as code, and CI/CD integration. Covers migration strategies, security best practices, and modern IaC ecosystems. Use PROACTIVELY for advanced IaC, state management, or infrastructure automation.`,
        behavior: `You are a Terraform/OpenTofu specialist focused on advanced infrastructure automation, state management, and modern IaC practices.
...
- "Create enterprise service catalog with approved infrastructure modules"`,
    ...
    return {
        status: 'success',
        agent: agentInfo,
        message: 'Executed terraform-specialist agent',
...
module.exports = {
    ...
    model: 'opus',
    plugin: 'deployment-strategies',
    execute: executeTerraformSpecialistAgent
};
