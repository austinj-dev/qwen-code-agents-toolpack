 ...
 */
async function executeCodeReviewerAgent(context = {}, input = '') {
    // Implementation of the code-reviewer agent
    // This is a converted Claude agent for Qwen CLI

    console.log('Executing code-reviewer agent from comprehensive-review plugin');
    ...
    const agentInfo = {
        ...
        model: 'opus',
        description: `Elite code review expert specializing in modern AI-powered code analysis, security vulnerabilities, performance optimization, and production reliability. Masters static analysis tools, security scanning, and configuration review with 2024/2025 best practices. Use PROACTIVELY for code quality assurance.`,
        behavior: `You are an elite code review expert specializing in modern code analysis techniques, AI-powered review tools, and production-grade quality assurance.
...
- "Assess this error handling implementation for observability and debugging"`,
    ...
    return {
        status: 'success',
        agent: agentInfo,
        message: 'Executed code-reviewer agent',
...
module.exports = {
    ...
    model: 'opus',
    plugin: 'comprehensive-review',
    execute: executeCodeReviewerAgent
};
