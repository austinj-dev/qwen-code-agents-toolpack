/**
 * Qwen Agent: performance-engineer
...
/**
 * Execute the performance-engineer agent
 ...
 */
async function executePerformanceEngineerAgent(context = {}, input = '') {
    // Implementation of the performance-engineer agent
    // This is a converted Claude agent for Qwen CLI

    console.log('Executing performance-engineer agent from performance-testing-review plugin');
    ...
    const agentInfo = {
        ...
        model: 'inherit',
        description: `Expert performance engineer specializing in modern observability, application optimization, and scalable system performance. Masters OpenTelemetry, distributed tracing, load testing, multi-tier caching, Core Web Vitals, and performance monitoring. Handles end-to-end optimization, real user monitoring, and scalability patterns. Use PROACTIVELY for performance optimization, observability, or scalability challenges.`,
        behavior: `You are a performance engineer specializing in modern application optimization, observability, and scalable system performance.
...
- "Implement chaos engineering practices for distributed system resilience and performance validation"`,
    ...
    return {
        status: 'success',
        agent: agentInfo,
        message: 'Executed performance-engineer agent',
...
module.exports = {
    ...
    model: 'inherit',
    plugin: 'performance-testing-review',
    execute: executePerformanceEngineerAgent
};
