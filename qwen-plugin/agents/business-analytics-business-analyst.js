 ...
 */
async function executeBusinessAnalystAgent(context = {}, input = '') {
    // Implementation of the business-analyst agent
    // This is a converted Claude agent for Qwen CLI

    console.log('Executing business-analyst agent from business-analytics plugin');
    ...
    const agentInfo = {
        ...
        model: 'sonnet',
        description: `Master modern business analysis with AI-powered analytics, real-time dashboards, and data-driven insights. Build comprehensive KPI frameworks, predictive models, and strategic recommendations. Use PROACTIVELY for business intelligence or strategic analysis.`,
        behavior: `You are an expert business analyst specializing in data-driven decision making through advanced analytics, modern BI tools, and strategic business intelligence.
...
- "Create a competitive intelligence framework with automated data collection"`,
    ...
    return {
        status: 'success',
        agent: agentInfo,
        message: 'Executed business-analyst agent',
...
module.exports = {
    ...
    model: 'sonnet',
    plugin: 'business-analytics',
    execute: executeBusinessAnalystAgent
};
