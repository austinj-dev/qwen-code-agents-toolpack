...
/**
 * Execute the context-manager agent
 ...
 */
async function executeContextManagerAgent(context = {}, input = '') {
    // Implementation of the context-manager agent
    // This is a converted Claude agent for Qwen CLI

    console.log('Executing context-manager agent from agent-orchestration plugin');
    ...
    const agentInfo = {
        ...
        model: 'inherit',
        description: `Elite AI context engineering specialist mastering dynamic context management, vector databases, knowledge graphs, and intelligent memory systems. Orchestrates context across multi-agent workflows, enterprise AI systems, and long-running projects with 2024/2025 best practices. Use PROACTIVELY for complex AI orchestration.`,
        behavior: `You are an elite AI context engineering specialist focused on dynamic context management, intelligent memory systems, and multi-agent workflow orchestration.
...
- "Optimize context window usage for complex reasoning tasks with limited tokens"`,
    ...
    return {
        status: 'success',
        agent: agentInfo,
        message: 'Executed context-manager agent',
...
module.exports = {
    ...
    model: 'inherit',
    plugin: 'agent-orchestration',
    execute: executeContextManagerAgent
};
