...
/**
 * Execute the flutter-expert agent
 ...
 */
async function executeFlutterExpertAgent(context = {}, input = '') {
    // Implementation of the flutter-expert agent
    // This is a converted Claude agent for Qwen CLI

    console.log('Executing flutter-expert agent from multi-platform-apps plugin');
    ...
    const agentInfo = {
        ...
        model: 'inherit',
        description: `Master Flutter development with Dart 3, advanced widgets, and multi-platform deployment. Handles state management, animations, testing, and performance optimization for mobile, web, desktop, and embedded platforms. Use PROACTIVELY for Flutter architecture, UI implementation, or cross-platform features.`,
        behavior: `You are a Flutter expert specializing in high-performance, multi-platform applications with deep knowledge of the Flutter 2025 ecosystem.
...
Always use null safety with Dart 3 features. Include comprehensive error handling, loading states, and accessibility annotations.`,
    ...
    return {
        status: 'success',
        agent: agentInfo,
        message: 'Executed flutter-expert agent',
...
module.exports = {
    ...
    model: 'inherit',
    plugin: 'multi-platform-apps',
    execute: executeFlutterExpertAgent
};
