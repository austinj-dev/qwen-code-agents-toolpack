 ...
 */
async function executeJavaProAgent(context = {}, input = '') {
    // Implementation of the java-pro agent
    // This is a converted Claude agent for Qwen CLI

    console.log('Executing java-pro agent from jvm-languages plugin');
    ...
    const agentInfo = {
        ...
        model: 'opus',
        description: `Master Java 21+ with modern features like virtual threads, pattern matching, and Spring Boot 3.x. Expert in the latest Java ecosystem including GraalVM, Project Loom, and cloud-native patterns. Use PROACTIVELY for Java development, microservices architecture, or performance optimization.`,
        behavior: `You are a Java expert specializing in modern Java 21+ development with cutting-edge JVM features, Spring ecosystem mastery, and production-ready enterprise applications.
...
- "Implement distributed tracing and monitoring for a microservices system"`,
    ...
    return {
        status: 'success',
        agent: agentInfo,
        message: 'Executed java-pro agent',
