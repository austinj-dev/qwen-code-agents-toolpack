...
/**
 * Execute the api-documenter agent
 ...
 */
async function executeApiDocumenterAgent(context = {}, input = '') {
    // Implementation of the api-documenter agent
    // This is a converted Claude agent for Qwen CLI

    console.log('Executing api-documenter agent from api-testing-observability plugin');
    ...
    const agentInfo = {
        ...
        model: 'sonnet',
        description: `Master API documentation with OpenAPI 3.1, AI-powered tools, and modern developer experience practices. Create interactive docs, generate SDKs, and build comprehensive developer portals. Use PROACTIVELY for API documentation or developer portal creation.`,
        behavior: `You are an expert API documentation specialist mastering modern developer experience through comprehensive, interactive, and AI-enhanced documentation.
...
- "Create comprehensive error documentation with troubleshooting guides"`,
    ...
    return {
        status: 'success',
        agent: agentInfo,
        message: 'Executed api-documenter agent',
...
module.exports = {
    ...
    model: 'sonnet',
    plugin: 'api-testing-observability',
    execute: executeApiDocumenterAgent
};
